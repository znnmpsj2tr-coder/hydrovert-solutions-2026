      ...
      <div className="relative mx-auto flex min-h-[740px] w-full max-w-7xl items-center px-6 pb-16 pt-40 sm:min-h-[780px] sm:px-8 lg:px-12">
        <div className="max-w-3xl">
          ...
          <div className="mt-9 flex flex-wrap gap-3 sm:gap-4">
            <Link href="/terrain" className="inline-flex items-center gap-2 rounded-full border border-[#c9efa6]/60 bg-[#10271d]/30 px-6 py-3.5 font-semibold text-[#e8f8d9] transition hover:-translate-y-0.5 hover:bg-[#c9efa6]/15">Mesure de terrain</Link>
            <Link href="/devis" className="inline-flex items-center gap-2 rounded-full bg-[#c0ea93] px-6 py-3.5 font-bold text-[#10271d] transition hover:-translate-y-0.5 hover:bg-white">Demander un devis <ArrowRight size={18} /></Link>
