...
const steps = [
  ...
  ["04", "Accompagner la suite", "Après la projection, l'arrosage et la météo jouent un rôle essentiel dans l'installation de la végétation."],
];
